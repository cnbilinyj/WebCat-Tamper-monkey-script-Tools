...
(function() {
	...
	if (window.location.pathname === "/page/detail.html") {
		...
		let urls = [
			"https://cnbilinyj.github.io/WebCat-Tamper-monkey-script-Tools/WCSSPDLFaD/data_/",
			"https://jsd.cdn.zzko.cn/gh/cnbilinyj/WebCat-Tamper-monkey-script-Tools@main/WCSSPDLFaD/data_/"
		];
